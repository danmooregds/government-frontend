...
class WorldwideOrganisation::LinkedContactPresenterTest < ActiveSupport::TestCase
  ...
  test "#post_address returns the first post address from the content item as a formatted adress" do
    expected_address =
      "<address class=\"govuk-body font-normal\">British Embassy Manila<br/>120 Upper McKinley Road, McKinley Hill<br/>Taguig City<br/>Manila<br/>1634<br/>Philippines</address>"
